...
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | -------------------------------------------------------------------- | ---- | ------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [Persian_instruct_dataset](https://github.com/mostafaamiri/Persian_instruct_dataset)                      | ~10k examples — mostly single-step instruction → output pairs | General / mixed (products, books, household items, descriptions, QA) | 2023 | Not specified                         | GitHub repo          | Semi-Alpaca style; quality is moderate, outputs often generic or partially cover inputs.                                    |
